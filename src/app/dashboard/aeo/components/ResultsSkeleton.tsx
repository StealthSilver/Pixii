export function ResultsSkeleton() {
  return (
    <div className="mt-8 space-y-6">
      <div className="animate-pulse rounded-xl border border-border/80 bg-card/90 p-6 ring-1 ring-black/[0.03] dark:ring-white/[0.05]">
      ...
      <div className="animate-pulse rounded-xl border border-border/80 bg-card/90 p-5 ring-1 ring-black/[0.03] dark:ring-white/[0.05]">
