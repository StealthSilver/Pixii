...
const primaryBtn =
  "rounded-lg bg-primary px-3 py-1.5 text-xs font-semibold text-primary-foreground shadow-sm ring-1 ring-black/10 transition-colors hover:bg-primary/90 disabled:opacity-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary/40 dark:ring-white/15";

function VariationSkeleton() {
  return (
    <div className="space-y-2 rounded-xl border border-border/80 bg-muted/60 p-4 animate-pulse dark:bg-muted/40">
...
export const WriteTab = forwardRef<WriteTabHandle, WriteTabProps>(
  function WriteTab(
    ...
    const selectClass =
      "min-h-10 w-full rounded-lg border border-border bg-card px-3 py-2 text-sm font-medium text-foreground shadow-sm ring-1 ring-black/[0.04] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary/35 dark:ring-white/[0.06]";

    return (
      <div ref={rootRef} className="scroll-mt-6">
        <div className="grid gap-6 lg:grid-cols-5 lg:gap-8">
          <div className="space-y-4 rounded-xl border border-border/70 bg-card/90 p-4 shadow-sm ring-1 ring-black/[0.03] backdrop-blur-[1px] lg:col-span-2 dark:ring-white/[0.05]">
            <div>
            ...
            <div>
              ...
              <input
                ...
                className="mt-1.5 w-full rounded-lg border border-border bg-card px-3 py-2 text-sm text-foreground shadow-sm ring-1 ring-black/[0.04] placeholder:text-muted-foreground/75 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary/35 dark:ring-white/[0.06]"
              />
            </div>
          ...
          <div className="lg:col-span-3">
            <div className="min-h-[280px] rounded-xl border border-border/80 bg-card/95 p-4 shadow-sm ring-1 ring-black/[0.03] backdrop-blur-[1px] dark:ring-white/[0.05]">
              {generating ? (
                ...
                <ul className="space-y-4">
                  {variations.map((text, idx) => {
                    ...
                    return (
                      <li
                        key={idx}
                        className="rounded-xl border border-border/80 bg-background/80 p-4 ring-1 ring-black/[0.02] dark:bg-background/40 dark:ring-white/[0.04]"
                      >
